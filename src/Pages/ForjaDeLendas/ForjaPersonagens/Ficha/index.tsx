...
function Ficha() {  
  ...
  return fichaEscolhida._id !== "" ? (
    <section className={styles.paginaFicha}>
      <div
        className={`${styles.paginaFicha__modal} ${deletando
            ? styles.paginaFicha__modal__aberto
            : styles.paginaFicha__modal__fechado
          }`}
      >
      ...
      <section className={styles.paginaFicha__ficha}>
        ...
        <div className={styles.paginaFicha__ficha__body}>
          <div
            className={`${isMobile && mostraCaracteristicas && styles.someDaTela
              }`}
            key={"valores"}
          >
            <FichaAtributos
              _id={fichaEscolhida._id}
              atributos={fichaEscolhida.atributos}
            />
          </div>
          <div
            className={`${isMobile && !mostraCaracteristicas && styles.someDaTela
      ...
      <div className={styles.paginaFicha__btnDeleta}>
        <BtnComum onClick={() => setDeletando(true)}>
          <RiDeleteBinFill /> Deletar Personagem
        </BtnComum>
      </div>
    </section>
  ) : (
